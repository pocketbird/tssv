    ...
    buildcontrol: {
      dist: {
        options: {
          ...
          remote: 'git@github.com:pocketbird/tssv.git',
          branch: 'gh-pages'
        }
      }
    },
      ...
      dist: {
        options: {
          patterns: [
            {
              match: /("|'?)\/?styles\//g,
              replacement: '$1http://pocketbird.github.io/tssv/styles/'
            },
            {
              match: /("|'?)\/?scripts\//g,
              replacement: '$1http://pocketbird.github.io/tssv/scripts/'
            },
            {
              match: /(<a[^>]*href="?)(\/)/g,
              replacement: '$1http://pocketbird.github.io/tssv/'
            },
            {
              match: /(<form[^>]*action="?)(\/)/g,
              replacement: '$1http://pocketbird.github.io/tssv/'
